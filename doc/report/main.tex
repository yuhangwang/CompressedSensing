...
\input{wstep/wstep}
\newpage{}
\input{analiza/analiza}
\newpage{}
\input{testowanie/testowanie}
\newpage{}
\input{rezultaty/rezultaty}
\newpage{}
...
\begin{appendices}
\input{dodatek/opis_zadania}
\input{dodatek/dokumentacja_techniczna}
\input{dodatek/spis_zawartosci}
\input{dodatek/historia_zmian}
\end{appendices}
